...
bool linearSearchUni(const University universities[], int numUniversities, int targetRank, const std::string &targetName, double targetScore, const std::string &searchCriteria)
{
